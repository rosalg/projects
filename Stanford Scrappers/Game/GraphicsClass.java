...
public class GraphicsClass extends GraphicsProgram implements ComponentListener, MapEnnumerations, MapConstants, BodyConstants {
	...
	AudioClip gameMusic;
	AudioClip mapSelectMusic = MediaTools.loadAudioClip("assets/audio/mapselect.wav");
	...
	public void update() {
		...
		if (gameStage == STAGE_SELECTION) {
			MapSelectionClass.addImageToCanvas("assets/art/Map1.jpg", MapSelectionClass.map1Canvas);
			MapSelectionClass.addImageToCanvas("assets/art/Map2.jpg", MapSelectionClass.map2Canvas);
			MapSelectionClass.addImageToCanvas("assets/art/Map3.jpg", MapSelectionClass.map3Canvas);
			MapSelectionClass.addImageToCanvas("assets/art/Map4.jpg", MapSelectionClass.map4Canvas);
			MapSelectionClass.addImageToCanvas("assets/art/Map5.jpg", MapSelectionClass.map5Canvas);
			MapSelectionClass.addImageToCanvas("assets/art/Map6.jpg", MapSelectionClass.map6Canvas);
		}
	...
	private void showTitleScreen() {
		AudioClip titleScreen = MediaTools.loadAudioClip("assets/audio/titlescreen.au");
		titleScreen.loop();
		...
		logo = new GImage("assets/art/StanfordLogo.jpg");
		logo.setSize(getWidth()/1.5, getHeight());
		add(logo, getWidth()/2-logo.getWidth()/2, 0);
	...
	private void showMenu() {
		AudioClip menuMusic = MediaTools.loadAudioClip("assets/audio/map1music.au");
		menuMusic.loop();
		loopTracker = 1;
		menuScreen = new GImage("assets/art/menuArt.png");
