...
public class MapSelectionClass extends Program{
	...
	public void addAllButtons() {
		container.add(map1);
		addImageToCanvas("assets/art/Map1.jpg", map1Canvas);
		container.add(map1Canvas);
		
		container.add(map2);
		addImageToCanvas("assets/art/Map2.jpg", map2Canvas);
		container.add(map2Canvas);
		
		container.add(map3);
		addImageToCanvas("assets/art/Map3.jpg", map3Canvas);
		container.add(map3Canvas);
		
		container.add(map4);
		addImageToCanvas("assets/art/Map4.jpg", map4Canvas);
		container.add(map4Canvas);
		
		container.add(map5);
		addImageToCanvas("assets/art/Map5.jpg", map5Canvas);
		container.add(map5Canvas);
		
		container.add(map6);
		addImageToCanvas("assets/art/Map6.jpg", map6Canvas);
	...
	public GImage getMapChoice(String buttonClicked) {
		int map = 0;
		AudioClip temp = MediaTools.loadAudioClip("assets/audio/music.au");
		if (buttonClicked.equals("Map 1: Nightinggale")) {
			selectedMap = new GImage("assets/art/Map1.jpg");
			map = 1;
			temp = MediaTools.loadAudioClip("assets/audio/map1music.au");
		} else if (buttonClicked.equals("Map 2: Forbidden Desert")) {
			selectedMap = new GImage("assets/art/Map2.jpg");
			map = 2;
			temp = MediaTools.loadAudioClip("assets/audio/map2music.au");
		} else if (buttonClicked.equals("Map 3: Howling Forest")) {
			selectedMap = new GImage("assets/art/Map3.jpg");
			map = 3;
			temp = MediaTools.loadAudioClip("assets/audio/map3music.au");
		} else if (buttonClicked.equals("Map 4: The Pirate's Cove")) {
			selectedMap = new GImage("assets/art/Map4.jpg");
			map = 4;
			temp = MediaTools.loadAudioClip("assets/audio/map4Music.wav"); 
		} else if (buttonClicked.equals("Map 5: Break of Light")) {
			selectedMap = new GImage("assets/art/Map5.jpg");
			map = 5;
			temp = MediaTools.loadAudioClip("assets/audio/map5music.au");
		} else if (buttonClicked.equals("Map 6: Forsaken Plains")) {
			selectedMap = new GImage("assets/art/Map6.jpg");
			map = 6;
		}
