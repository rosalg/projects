...
public class MainCharacter extends GCompound implements BodyConstants{
	
	public MainCharacter(double width, double height, Color pantsColor, Color shirtColor, Color shoeColor) {
		...
		add(leftArm);
		rightArm = new GRect(PANT_W*2+ARM_WIDTH+THIGH_GAP, height-PANT_L-BODY_HEIGHT-FOOT_LENGTH, ARM_WIDTH, ARM_LENGTH);
		...
		add(head, FOOT_WIDTH-NECK_WIDTH/4-JAW_LINE_W*2.25, height-PANT_L-FOOT_LENGTH-BODY_HEIGHT-NECK_LENGTH);
		...
		add(mouth,neck.getX()+2, height-PANT_L-FOOT_LENGTH-BODY_HEIGHT-NECK_LENGTH-head.getHeight()/2.25);
	}
