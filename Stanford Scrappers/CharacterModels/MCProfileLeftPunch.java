...
public class MCProfileLeftPunch extends GCompound implements BodyConstants{
	
	public MCProfileLeftPunch(double width, double height, Color pantsColor, Color shirtColor, Color shoeColor) {
		...
		arm = new GRect(FOOT_LENGTH/2 + FOOT_WIDTH - PANT_W - ARM_LENGTH, -FOOT_LENGTH-PANT_L-BODY_HEIGHT+ARM_OFFSET, ARM_LENGTH, ARM_WIDTH);
		arm.setFilled(true);
